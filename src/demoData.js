export const initialState = {
  ...
  mods: [
    ...
    { id: 4, name: 'Old Lanterns', author: 'Blue Finch', version: '0.5.0', versions: ['0.5.0'], enabled: false, sessionEnabled: false, dependencies: ['Base Content'], status: 'Needs update', sheet: 1, frame: 4, description: 'An archived lantern palette retained for older progression manifests.' },
  ],
  modCatalog: [
