export const initialState = {
  ...
  mods: [
    { id: 1, name: 'Base Content', author: 'Gubsy', version: '1.0.0', versions: ['1.0.0'], enabled: true, sessionEnabled: true, required: true, dependencies: [], status: 'Compatible', sheet: 1, frame: 0, description: 'Core Splonks definitions and assets required by every session.' },
    { id: 2, name: 'Cartographer’s Desk', author: 'Yarrow', version: '3.0.2', versions: ['3.0.2','2.9.4','2.8.1'], enabled: true, sessionEnabled: true, dependencies: ['Base Content'], status: 'Compatible', sheet: 3, frame: 2, description: 'Shared map markers, route notes, unexplored-room hints, and color-coded party pings.' },
    { id: 3, name: 'Pocket Expedition', author: 'Mossbyte', version: '0.9.1', versions: ['0.9.1','0.8.7'], enabled: false, sessionEnabled: false, dependencies: ['Base Content'], status: 'Compatible', sheet: 3, frame: 3, description: 'A complete toy-scale visual conversion with miniature equipment and diorama props.' },
    { id: 4, name: 'Old Lanterns', author: 'Blue Finch', version: '0.5.0', latestVersion: '1.1.0', versions: ['1.1.0','0.5.0'], enabled: false, sessionEnabled: false, dependencies: ['Base Content'], status: 'Needs update', sheet: 1, frame: 4, description: 'An archived lantern palette retained for older progression manifests.' },
  ],
  modCatalog: [
